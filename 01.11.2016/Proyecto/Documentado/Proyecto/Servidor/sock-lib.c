...
/**
  \fn int Aceptar_pedidos (int sockfd,struct sockaddr_in my_addr )
...
/**
  ...
  \details Manda un mesaje del tipo "Disconn" a todos los clientes
  \author Sebastian Torres
  \date 27/11/2012
  \param[in] socket Socket asociado al cliente que intenta mandar el mensaje 
  \param[in] CID CID del cliente que intenta mandar el mensaje
...
/**
  \fn void sendDisconnectMessage(int sockfd,int CID)
...
/**
  \fn void sendConnectMessage(int sockfd,int CID)
